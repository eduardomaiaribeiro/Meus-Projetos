...
# João trabalha como garçom em um restaurante e precisa calcular a gorjeta que os 
# clientes deixam ao pagar a conta. O restaurante sugere uma gorjeta de 10%, 
# mas alguns clientes podem escolher dar mais ou menos.

# Para agilizar o processo, João quer um programa que receba o valor total da conta 
# e a porcentagem de gorjeta desejada e exiba o valor final que o cliente deverá pagar.
